...
@register_model("Global-ViSNet")
class GlobalViSNetModel(FairseqEncoderModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--apply-init",
            action="store_true",
            help="use custom param initialization for Global-ViSNet",
        )
...
class GlobalViSNet(FairseqEncoder):
    ...
    def __init__(self, args):
        ...
        if args.model_type == 'v1':
            self.molecule_encoder = ViSNetEncoder_V1(
            ...
            self.molecule_encoder = ViSNetEncoder_V2(
                num_atoms=args.num_atoms,
                num_in_degree=args.num_in_degree,
                num_out_degree=args.num_out_degree,
                num_edges=args.num_edges,
...
@register_model_architecture("Global-ViSNet", "global_visnet")
...
@register_model_architecture("Global-ViSNet", "global_visnet_v1_base")
...
@register_model_architecture("Global-ViSNet", "global_visnet_v2_base")
def bert_base_architecture(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 768)
    args.share_encoder_input_output_embed = getattr(
        args, "share_encoder_input_output_embed", False
